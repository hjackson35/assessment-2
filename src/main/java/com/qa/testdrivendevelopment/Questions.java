...
public class Questions {
	...
	public int returnPosition(String input, char letter) {
		...
		if (index >= 0) {
			...
			System.out.println("The first 'w' appears at position:"+index);
		}
		else{
			return -1;
		}
	...
	public String zipped(String input1, String input2) {
		...
		public static void main(String args[]) {
		    ...
		    String str1 = letter.next();
		    System.out.println("Enter the second string: ");
		    String str2 = letter.next();
	...
	public boolean iBeforeE(String input) {
		...
		String a = new String("Believe");
		String b = new String("Ceiling");
		boolean ie = true;
		
		int IbEaC = a.indexOf("ie");
